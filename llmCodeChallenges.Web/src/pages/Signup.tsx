            ...
            <div className="layout-content-container flex flex-col w-lg py-5 flex-1">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex px-4 py-3 mx-auto min-w-[45vw]">
                  <button
                    type="submit"
                    className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 flex-1 bg-[#1380ec] text-white text-sm font-bold leading-normal tracking-[0.015em]"
                  >
